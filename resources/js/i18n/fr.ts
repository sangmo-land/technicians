const fr = {
    ...
    // ─── Work Feed ───────────────────────────────────────
    feed: {
        pageTitle: 'Fil des travaux',
        heading: 'Fil des travaux',
        subheading: 'Publiez ce que vous devez faire faire et laissez les techniciens venir à vous.',
        composerPlaceholder: 'De quoi avez-vous besoin ? ex. « Je cherche un électricien pour câbler une maison de 3 chambres à Bonabéri... »',
        detailsCategory: 'Catégorie de métier',
        detailsRegion: 'Région',
        detailsCity: 'Ville / Quartier',
        detailsNeeded: 'Techniciens requis',
        detailsBudget: 'Budget',
        budgetPlaceholder: 'ex. 25 000 FCFA / jour',
        anyCategory: 'Tout métier',
        selectRegion: 'Choisir la région',
        publish: 'Publier',
        loginToPost: 'Connectez-vous pour publier votre besoin ou manifester votre intérêt.',
        ...
        statusFilled: 'Pourvu',
        statusClosed: 'Fermé',
        yourPost: 'Votre annonce',
        needed: '{{n}} requis',
        interestedCount: '{{n}} intéressé(s)',
        slots: '{{count}} sur {{needed}} intéressés',
        imInterested: "Ça m'intéresse",
        interested: 'Intéressé',
        interestedTechnicians: 'Techniciens intéressés',
        noInterestsYet: 'Aucun intérêt pour le moment — soyez le premier !',
    ...
    siteHome: {
        ...
        findHeadline: 'Les grands travaux commencent entre de bonnes mains.',
        findSub: 'Recherchez des professionnels qualifiés partout au Cameroun par nom, métier ou région.',
        professionalsReady: '{{count}} professionnels à découvrir',
        keywordLabel: 'Qui recherchez-vous ?',
        keywordPlaceholder: 'Nom, compétence ou service',
        tradeLabel: 'Métier',
        allTrades: 'Tous les métiers',
        regionLabel: 'Région',
        allRegions: 'Toutes les régions',
    ...
    register: {
        ...
        roleWorker: 'Technicien',
        roleWorkerDesc: 'Je propose mes compétences et me fais embaucher',
        ...
        roleClient: 'Employeur',
        roleClientDesc: 'Je cherche à embaucher des techniciens',
