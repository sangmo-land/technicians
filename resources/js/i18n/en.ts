const en = {
    ...
    feed: {
        pageTitle: 'Work Feed',
        heading: 'Work Feed',
        subheading: 'Post what you need done and let technicians come to you.',
        composerPlaceholder: 'What do you need done? e.g. "Looking for an electrician to wire a 3-bedroom house in Bonaberi..."',
        detailsCategory: 'Trade category',
        detailsRegion: 'Region',
        detailsCity: 'City / Neighbourhood',
        detailsNeeded: 'Technicians needed',
        detailsBudget: 'Budget',
        budgetPlaceholder: 'e.g. 25,000 FCFA / day',
        anyCategory: 'Any trade',
        selectRegion: 'Select region',
        publish: 'Publish post',
        loginToPost: 'Log in to post what you need done, or to show interest in a job.',
        ...
        slots: '{{count}} of {{needed}} interested',
        imInterested: "I'm interested",
        interested: 'Interested',
        interestedTechnicians: 'Interested technicians',
        noInterestsYet: 'No interest shown yet — be the first!',
    ...
    siteHome: {
        ...
        findHeadline: 'Great work starts with the right hands.',
        findSub: 'Search skilled professionals across Cameroon by name, trade, or region.',
        professionalsReady: '{{count}} professionals to discover',
        keywordLabel: 'Who do you need?',
        keywordPlaceholder: 'Name, skill, or service',
        tradeLabel: 'Trade',
        allTrades: 'All trades',
        regionLabel: 'Region',
        allRegions: 'All regions',
